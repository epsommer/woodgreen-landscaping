    ...
    <section className="py-20 bg-white dark:bg-[#2F3B30] text-[#2F3B30] dark:text-white">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold mb-4">4-Season Landscape Visualization</h2>
          <p className="text-xl text-[#4A5D4C] dark:text-gray-400 max-w-3xl mx-auto">
            See How Year-Round Care Keeps Beauty Alive Through Every Season
          </p>
        </div>
        ...
        <div className="flex justify-center items-center gap-4 mb-8 flex-wrap">
              ...
              className={`
                ...
                ${
                  currentSeason === season
                    ? "bg-nature-500 text-white scale-110 shadow-lg"
                    : "bg-[#F0F4F0] dark:bg-white/10 text-[#2F3B30] dark:text-gray-300 hover:bg-white dark:hover:bg-white/20"
                }
              `}
            >
          ...
          <Button
            ...
            className="ml-4 border-[#2F3B30]/20 dark:border-white/20 hover:bg-[#F0F4F0] dark:hover:bg-white/10"
          >

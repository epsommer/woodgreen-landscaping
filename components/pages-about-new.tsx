...
import { Award, Users, Leaf, CheckCircle2, Battery, ChevronDown, ChevronUp } from "lucide-react";
...
export function AboutNew() {
  ...
  const values = [
    ...
    },
    {
      ...
      color: "#60a5fa",
      detailedContent: "I didn't learn landscaping from a manual. I learned it from my father, a master craftsman with over two decades shaping the land around Woodgreen, Ontario. He taught me to read soil, understand drainage, respect native ecosystems, and build landscapes that work with nature, not against it. Now I bring that legacy knowledge to Toronto, blended with modern sustainable techniques and eco-friendly practices.",
    },
    {
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6 text-lg text-[#4A5D4C] dark:text-gray-300 leading-relaxed">
              ...
              <blockquote className="relative my-8 p-8 bg-gradient-to-br from-[#CEFF65]/20 via-nature-100/30 to-[#4ade80]/20 dark:from-[#4A5D4C]/30 dark:via-[#2F3B30]/20 dark:to-[#1C1C1C]/40 rounded-2xl border-l-4 border-[#CEFF65] dark:border-nature-500 shadow-lg">
                <div className="absolute top-4 left-4 text-6xl text-[#CEFF65]/30 dark:text-nature-500/30 font-serif leading-none">&ldquo;</div>
                <p className="text-xl md:text-2xl font-medium text-[#2F3B30] dark:text-white pl-8 leading-relaxed">
                  As a one-person operation, I offer something larger companies can&apos;t: <span className="text-nature-600 dark:text-nature-400 font-semibold">personal attention</span>, <span className="text-nature-600 dark:text-nature-400 font-semibold">artistic vision</span>, <span className="text-nature-600 dark:text-nature-400 font-semibold">complete creative control</span>, and <span className="text-nature-600 dark:text-nature-400 font-semibold">genuinely eco-friendly practices</span>.
                </p>
                <div className="absolute bottom-4 right-6 text-6xl text-[#CEFF65]/30 dark:text-nature-500/30 font-serif leading-none">&rdquo;</div>
              </blockquote>

              <p>
                What started with neighbors three years ago is now expanding beyond the local community. I&apos;m currently formalizing Woodgreen Landscaping to serve the Greater Toronto Area more broadly. I'm adding capabilities like hardscapes while maintaining the boutique, personal approach that got me here.
              </p>
            ...
            {values.map((value, index) => {
              ...
              return (
                <Card
                  ...
                  style={isSelected ? { ringColor: value.color } : {}}
                >
